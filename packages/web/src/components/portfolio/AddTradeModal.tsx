      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-xl border border-white/10 bg-[#12121a] p-6 shadow-2xl"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input label="Symbol" value={form.symbol} onChange={(e) => setForm((f) => ({ ...f, symbol: e.target.value }))} placeholder="AAPL" required />
              ...
              <div className="grid grid-cols-2 gap-3">
                <Input label="Fee" type="number" step="0.01" value={form.fee} onChange={(e) => setForm((f) => ({ ...f, fee: e.target.value }))} placeholder="0.00" />
